...
- **The planning agent** (`leanlog-plan` or a human) produces an implementation
...
- Any durable decisions made during the dialogue can flow naturally to
  downstream artifacts (`leanlog-plan`, the commit message, `docs/solutions/`)
...
decision flows to `leanlog-plan` (or directly to commit message, or to
