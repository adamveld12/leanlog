---
description: |
    Brainstorm a new feature in the app and save it somewhere. Build out full spec and user story.
    Use whenever the user says things like:
    - "I want to brain storm some ideas"
    - "Lets add a new feature to the backlog"
    - "add a task/issue for this...."
    - "I want to build..."
    - "I want the app to..."
...
Brainstorming helps answer **WHAT** to build through collaborative dialogue. It precedes `/leanlog-plan`, which answers **HOW** to build it.
