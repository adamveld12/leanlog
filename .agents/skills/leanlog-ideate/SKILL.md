...
`leanlog-ideate` -> `leanlog-brainstorm` -> `leanlog-plan`

- `leanlog-ideate` answers: "What are the strongest ideas worth exploring?"
- `leanlog-brainstorm` answers: "What exactly should one chosen idea mean?"
- `leanlog-plan` answers: "How should it be built?"
...
3. **Route action into brainstorming** - Ideation identifies promising directions; `leanlog-brainstorm` defines the selected one precisely enough for planning. Do not skip to planning from ideation output.
